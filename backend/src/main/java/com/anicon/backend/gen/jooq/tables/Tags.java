...
public class Tags extends TableImpl<TagsRecord> {
     ...
     */
    public final TableField<TagsRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("gen_random_uuid()"), SQLDataType.UUID)), this, "");
    ...
    public EventTagsPath eventTags() {
        if (_eventTags == null)
            _eventTags = new EventTagsPath(this, null, Keys.EVENT_TAGS__EVENT_TAGS_TAG_ID_FKEY.getInverseKey());
