...
import com.anicon.backend.gen.jooq.tables.records.PostTagsRecord;
...
public class Keys {
    ...
    public static final UniqueKey<PostTagsRecord> POST_TAGS_PKEY = Internal.createUniqueKey(PostTags.POST_TAGS, DSL.name("post_tags_pkey"), new TableField[] { PostTags.POST_TAGS.POST_ID, PostTags.POST_TAGS.TAG_ID }, true);
    ...
    public static final UniqueKey<ScrapedEventsRecord> SCRAPED_EVENTS_PKEY = Internal.createUniqueKey(ScrapedEvents.SCRAPED_EVENTS, DSL.name("scraped_events_pkey"), new TableField[] { ScrapedEvents.SCRAPED_EVENTS.ID }, true);
    public static final UniqueKey<ScrapedEventsRecord> SCRAPED_EVENTS_SOURCE_URL_KEY = Internal.createUniqueKey(ScrapedEvents.SCRAPED_EVENTS, DSL.name("scraped_events_source_url_key"), new TableField[] { ScrapedEvents.SCRAPED_EVENTS.SOURCE_URL }, true);
    ...
    public static final ForeignKey<PostTagsRecord, PostsRecord> POST_TAGS__POST_TAGS_POST_ID_FKEY = Internal.createForeignKey(PostTags.POST_TAGS, DSL.name("post_tags_post_id_fkey"), new TableField[] { PostTags.POST_TAGS.POST_ID }, Keys.POSTS_PKEY, new TableField[] { Posts.POSTS.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PostTagsRecord, TagsRecord> POST_TAGS__POST_TAGS_TAG_ID_FKEY = Internal.createForeignKey(PostTags.POST_TAGS, DSL.name("post_tags_tag_id_fkey"), new TableField[] { PostTags.POST_TAGS.TAG_ID }, Keys.TAGS_PKEY, new TableField[] { Tags.TAGS.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
