  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-sm">
        ...
        <p className="text-sm text-gray-500 -mt-1">{priceDisplay} per ticket</p>
        ...
        <div className="flex flex-col gap-3 mt-1">
          ...
          <button
            ...
            disabled={!!loading}
            className="flex items-center gap-4 p-4 border-2 border-gray-100 rounded-2xl
          ...
          >
            <div className="w-11 h-11 bg-orange-100 group-hover:bg-orange-200 rounded-xl
              flex items-center justify-center flex-shrink-0 transition-colors duration-200">
              <svg className="w-5 h-5 text-[#FF7927]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 mt-0.5">ABA Pay, KHQR — redirects to scan &amp; pay</p>
            </div>
            {loading === "qr" && (
              <svg className="w-4 h-4 text-[#FF7927] animate-spin flex-shrink-0"
          ...
          <button
            ...
            className="flex items-center gap-4 p-4 border-2 border-gray-100 rounded-2xl
              ...
              disabled:opacity-50 disabled:cursor-not-allowed text-left group"
          >
            <div className="w-11 h-11 bg-blue-100 group-hover:bg-blue-200 rounded-xl
              flex items-center justify-center flex-shrink-0 transition-colors duration-200">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 mt-0.5">Visa, Mastercard — pay without leaving this page</p>
            </div>
            {loading === "card" && (
              <svg className="w-4 h-4 text-[#FF7927] animate-spin flex-shrink-0"
                fill="none" viewBox="0 0 24 24">
