...
export const authApi = {
  ...
  // Create a new profile during signup
  createProfile: (data) => api.post('/api/profiles', data),

  // Cleanup user if signup fails midway
  cleanupUser: () => api.delete('/api/auth/cleanup'),

  // Resend verification email (public endpoint)
  resendVerification: (email) => api.post('/api/auth/resend-verification', { email }),

  // Send magic link (public endpoint)
  sendMagicLink: (email, redirectTo) => api.post('/api/auth/magic-link', { email, redirectTo }),
};
