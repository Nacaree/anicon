...
function Sidebar() {
    ...
    if ($[0] !== "bb0f3733491c11d8d8b2382e4dcf2e0f28570ddc48a33e18b763ab243e6bd243") {
        for(let $i = 0; $i < 32; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "bb0f3733491c11d8d8b2382e4dcf2e0f28570ddc48a33e18b763ab243e6bd243";
    }
    ...
    const t0 = `${isCollapsed ? "w-20" : "w-64"} bg-white h-screen fixed left-0 top-0 flex flex-col py-4 border-r border-gray-200 transition-all duration-300`;
    let t1;
    if ($[1] !== isCollapsed) {
        t1 = ({
    ...
    const t4 = `flex items-center gap-3 px-4 py-3 rounded-lg bg-orange-500 text-white ${isCollapsed ? "justify-center" : ""}`;
    let t5;
    ...
    let t6;
    if ($[7] !== isCollapsed) {
        t6 = !isCollapsed && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    const t8 = `flex items-center gap-3 px-4 py-3 rounded-lg text-gray-600 hover:bg-gray-100 ${isCollapsed ? "justify-center" : ""}`;
    let t9;
    ...
    let t10;
    if ($[13] !== isCollapsed) {
        t10 = !isCollapsed && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            className: "text-sm font-medium",
            children: "Events"
        }, void 0, false, {
            fileName: "[project]/src/components/Sidebar.js",
    ...
    const t12 = `flex items-center gap-3 px-4 py-3 rounded-lg text-gray-600 hover:bg-gray-100 ${isCollapsed ? "justify-center" : ""}`;
    let t13;
    ...
    let t14;
    if ($[19] !== isCollapsed) {
        t14 = !isCollapsed && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            className: "text-sm font-medium",
            children: "Tickets"
        }, void 0, false, {
            fileName: "[project]/src/components/Sidebar.js",
...
//# sourceMappingURL=_dbf4f9f7._.js.map