export default function PostCard() {
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-3 mb-3 max-w-4xl mx-auto">
      {/* User Header */}
      ...
      {/* Text Box */}
      <div className="bg-gray-200 rounded-lg p-4 mb-3 flex items-center justify-center h-20">
        <p className="text-gray-800 font-medium">Text box</p>
      </div>

      {/* Image Box */}
      <div className="bg-gray-200 rounded-lg mb-3 flex items-center justify-center h-150">
